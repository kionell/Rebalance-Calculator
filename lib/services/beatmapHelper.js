const Beatmap = require('../classes/beatmap.js');
...
function getBeatmapTemplate(path)
{
  return new Beatmap(parseBeatmapFile(path));
}
...
function parseBeatmapFile(path)
{
  ...
  return Beatmap.fromOsu(file.toString());
}
