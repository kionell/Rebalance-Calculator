...
class HitProbabilities
{
  ...
  static calculateCheeseHitProb(movement, tp, cheeseLevel)
  {
    ...
    let cheeseMovementTime = movement.movementTime 
      * (1 + perMovementCheeseLevel * movement.cheesableRatio);

    return FittsLaw.calculateHitProb(movement.distance, cheeseMovementTime, tp);
  }
