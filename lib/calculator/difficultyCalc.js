const NoteDensity = require('./preprocessing/noteDensity.js');
const Mean = require('./mathUtil/mean.js');

const FingerControl = require('./skills/fingerControl.js');
const Aim = require('./skills/aim.js');
const Tap = require('./skills/tap.js');

const Mods = require('../classes/mods.js');
const Difficulty = require('../classes/difficulty.js');

const BeatmapHelper = require('../services/beatmapHelper.js');
...
class DifficultyCalculator
{
  ...
  calculate()
  {
    ...
    let preemptNoClockRate = BeatmapHelper.difficultyRange(modStats.AR, 1800, 1200, 450);
    ...
    let hitWindowGreat = Math.trunc(BeatmapHelper.difficultyRange(modStats.OD, 80, 50, 20)) / clockRate;
    let preempt = Math.trunc(BeatmapHelper.difficultyRange(modStats.AR, 1800, 1200, 450)) / clockRate;
  ...
  #applyMods(mods) 
  {
    ...
    BeatmapHelper.completeBeatmap(this.beatmap, modStats);
