...
class DifficultyCalculator
{
  ...
  calculate(totalHits = undefined)
  {
    ...
    stars.tap = tap_multiplier
      * Math.pow(atts.tap.tapDiff, sr_exponent);

    stars.aim = aim_multiplier 
      * Math.pow(atts.aim.fcProbTp, sr_exponent);

    stars.finger = finger_control_multiplier
      * Math.pow(atts.finger, sr_exponent); 
