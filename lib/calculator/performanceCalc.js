...
class PerformanceCalculator
{
  ...
  calculate(difficulty, score)
  {
    ...
    let aimValue = this._computeAimValue(difficulty, score);
    let tapValue = this._computeTapValue(difficulty, score);
    let accuracyValue = this._computeAccuracyValue(difficulty, score);
