...
const MultiL2NormCorrection = require('../preprocessing/L2NormCorrection');
...
const correction0_moving_spline = LinearSpline.interpolateSorted([-1.0, 1.0], [1.1, 0]);
    ...
    if (obj0 !== null && d12 !== 0) {
      ...
      if (tRatio0 > t_ratio_threshold) {
        if (d01 === 0) {
          ...
          let correction0Moving = correction0_moving_spline.interpolate(cos012);
    ...
    if (obj3 && d12 != 0) {
      ...
      if (tRatio3 > t_ratio_threshold) {
        if (d23 === 0) {
          ...
          let correction3Moving = correction0_moving_spline.interpolate(cos123);
