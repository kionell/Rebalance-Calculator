...
{
  #x_offset; #y_offset; #offset; #scale;
  ...
  {
    x -= this.#x_offset.interpolate(distance);
    y -= this.#y_offset.interpolate(distance);
    let z = this.#offset.interpolate(distance);
    let c = this.#scale.interpolate(distance);
...
class MultiL2NormCorrection
{
  ...
  evaluate(distance, x, y)
  {
    ...
    result += this.#offset.interpolate(distance);

    return Logistic.logistic(result) * this.#scale.interpolate(distance);
  }

  static FLOW_0 = new MultiL2NormCorrection(
    // components
    [
  ...
  static SNAP_0 = new MultiL2NormCorrection(
    // components
    [
      new L2NormCorrection(
        snap0distances,
  ...
  static FLOW_3 = new MultiL2NormCorrection(
    // components
    [
      new L2NormCorrection(
        flow3distances,
  ...
  static SNAP_3 = new MultiL2NormCorrection(
    // components
    [
      new L2NormCorrection(
        snap3distances,
